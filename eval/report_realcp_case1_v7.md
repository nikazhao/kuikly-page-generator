...
|---|------|---------|------|---------|-------|--------|---------|-----------|
| 1 | 一个登录页面，有用户名输入框、密码输入框和登录按钮，按钮点击 | login | ❌ | 3 | 2 | 69.73 | 3880 | 7/7 |

## 未通过用例

- #1 一个登录页面，有用户名输入框、密码输入框和登录按钮，按钮点击后验证输入 — 修正 3 次后仍剩 2 个问题
    - /var/folders/tq/1vf6rlgx5_sf10wmxkj27g7c0000gn/T/tmpf_a66bzc.kt:98:29: error: unresolved reference 'confirm'.
    - /var/folders/tq/1vf6rlgx5_sf10wmxkj27g7c0000gn/T/tmpf_a66bzc.kt:101:29: error: unresolved reference 'cancel'.
